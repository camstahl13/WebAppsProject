...
public partial class AspnetuserroleContext : DbContext
{
    public AspnetuserroleContext()
    {
    }

    public AspnetuserroleContext(DbContextOptions<AspnetuserroleContext> options)
        : base(options)
    {
    }
